...
public class Main {
    static HashMap<String, User> users = new HashMap<>();//server side
    ...
    public static ArrayList<Message> selectReplies(Connection conn, int replyId) throws SQLException {
        ...
        while (results.next()) {
            ...
            Message message = new Message(id, replyId, name, text);//param
    ...
    public static Message selectMessage(Connection conn, int id) throws SQLException {
        ...
        public static void main(String[] args) throws SQLException {
            Server.createWebServer().start();Connection conn = DriverManager.getConnection("jdbc:h2:./main");
            createTables(conn);


        // route to send dowm html
        ...
        Spark.get(
                ...
                String userName = session.attribute("userName");
                    // add user if in hashmap,create user if not in hashmap
